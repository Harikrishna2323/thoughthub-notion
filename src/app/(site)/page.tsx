  ...
  return (
    <>
      <section className="overflow-hidden px-4 sm:px-6 mt-10 sm:flex sm:flex-col gap-4 md:justify-center md:items-center">
        <TitleSection
          ...
          title="All-In-One Collaboration and Productivity Platform For All"
          subheading=""
        />
    ...
    "
      ...
      <section className="px-4 sm:px-6 flex justify-center items-center flex-col relative">
        ...
        <TitleSection
          title={"Keep Track Of Your Meerings All In One place"}
          ...
          {PRICING_CARDS.map((card, idx) => {
            ...
            "
              ...
              "
                    ...
                    <p className="dark:text-washed-purple-800 my-4">
                      {card.description}
                    </p>
                    <Button
                      // variant="btn-primary"
